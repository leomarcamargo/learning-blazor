...
{
    public partial class MigrationRefazendoTudo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalaFilme", x => new { x.IdSala, x.IdFilme });
                    table.ForeignKey(
                        name: "FK_SalaFilme_Filme_IdFilme",
                        column: x => x.IdFilme,
                        principalTable: "Filme",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalaFilme_Sala_IdSala",
                        column: x => x.IdSala,
                        principalTable: "Sala",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "e50e27ce-4792-47fd-87b0-606250021ce0", "46240cac-b558-4db7-9051-b1548e2e25f6", "admin", "ADMIN" });
